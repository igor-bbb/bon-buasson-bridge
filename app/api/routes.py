...
def _facade_operation_request_schema() -> dict:
    return {
        'type': 'object',
        'properties': {
            'operation_type': {'type': 'string', 'description': 'Professional operation to execute through the facade.'},
            'payload': {'type': 'object', 'description': 'Operation-specific payload.', 'additionalProperties': True},
...
def _laboratory_facade_openapi_schema() -> dict:
    ...
    schema = {
        ...
        'info': {
            ...
            'version': 'LABORATORY-ACTIONS-0003-FACADE-API',
            'description': 'Official compact OpenAPI schema for VECTRA Laboratory GPT Actions. Product Owner imports this single URL. The schema exposes professional facade Actions only; Runtime performs detailed routing to internal services.',
        },
        'servers': [{'url': server_url}],
        'components': {
            'schemas': {},
        ...
        'x-vectra-release': 'LABORATORY-ACTIONS-0003',
...
def _internal_runtime_actions() -> list[dict]:
    ...
    for action in actions:
        ...
        action['release_version'] = 'LABORATORY-ACTIONS-0003'
    return actions
...
def _build_laboratory_facade_action_manifest() -> dict:
    ...
    return {
        ...
        'render_mode': 'vectra_laboratory_action_manifest',
        'release_version': 'LABORATORY-ACTIONS-0003',
        'schema_url': '/vectra/laboratory/openapi.json',
...
def vectra_laboratory_facade_knowledge(request: dict = None, x_vectra_laboratory_key: str | None = Header(default=None, alias='X-VECTRA-LABORATORY-KEY')):
    ...
    try:
        ...
        if operation_type == 'capitalize_confirmed_knowledge':
            return json_response(_facade_response(operation_type, 'knowledge_capitalization.capitalize_knowledge', '/vectra/knowledge/capitalization', capitalize_vectra_knowledge(payload), next_action='Read back capitalized knowledge through Professional or Business Knowledge API.'))

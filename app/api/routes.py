...
PUBLIC_SUMMARY_KEYS = ('context', 'metrics', 'structure', 'drain_block', 'goal', 'all_block', 'reasons_block', 'navigation')
...
def public_summary(payload):
    ...
    if level == 'sku':
        allowed = ('context', 'metrics', 'structure', 'drain_block', 'goal', 'focus_block', 'decision_block', 'provocation_block', 'all_block', 'reasons_block', 'navigation')
        return {key: payload.get(key) for key in allowed if key in payload}
    if level == 'network':
        allowed = ('context', 'metrics', 'structure', 'drain_block', 'goal', 'focus_block', 'decision_block', 'grouping_type', 'aggregation_level', 'all_block', 'reasons_block', 'navigation')
        return {key: payload.get(key) for key in allowed if key in payload}

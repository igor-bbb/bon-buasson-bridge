...
def _render_object_result_block(response):
    # CHANGE-006: Benchmark Money is no longer rendered as a separate money block.
    # The object screen must start from Performance Layer only: object vs previous period.

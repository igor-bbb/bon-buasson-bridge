...
def _laboratory_facade_openapi_schema() -> dict:
    ...
    schema = {
        ...
        'info': {
            ...
            'version': 'LABORATORY-KNOWLEDGE-0010-AUTOMATIC-KNOWLEDGE-EXTRACTION',
            'description': 'Official compact OpenAPI schema for VECTRA Laboratory GPT Actions. Product Owner imports this single URL. LABORATORY-KNOWLEDGE-0010 exposes a compact facade for automatic knowledge extraction and package preparation. VECTRA performs the professional session audit; Runtime accepts prepared packages and can also convert supplied session audit evidence into a normalized, deduplicated package, then performs incremental diff, safe batch persistence, readback verification and the final report.',
        },
        'servers': [{'url': server_url}],
        'components': {
            'schemas': {},

...
def vectra_query(request: VectraQueryRequest):
    ...
    if _ctx_level != 'assistant_dialogue' and render_only_payload.get('render_mode') not in {'list_only', 'reasons', 'kpi_only', 'voice_diagnostic', 'action_package', 'negotiation_workspace', 'task_workspace', 'post_meeting_workspace', 'execution_workspace', 'development_journal', 'development_journal_capture', 'development_journal_export', 'architecture_complete_gate', 'product_review', 'sprint_candidate', 'decision_capture', 'task_capture', 'feedback_capture', 'corporate_memory', 'closed_loop_status', 'product_intelligence'}:

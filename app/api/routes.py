...
def _laboratory_public_openapi_schema() -> dict:
    server_url = os.getenv('VECTRA_PUBLIC_RUNTIME_URL') or os.getenv('VECTRA_RUNTIME_URL') or os.getenv('RENDER_EXTERNAL_URL') or 'https://YOUR_RUNTIME_URL'
    ...
    return {
        ...
        'info': {
            ...
            'version': os.getenv('VECTRA_LABORATORY_SCHEMA_VERSION', 'FOUNDATION-0003'),
            'description': 'Public Action-facing API for VECTRA Laboratory. Contains only endpoints required for Product Verification of running Runtime.',
        },
        ...
        'components': {
            ...
            'schemas': {
                'RuntimeStatus': {'type': 'object', 'additionalProperties': True},
                'RuntimeSnapshot': {'type': 'object', 'additionalProperties': True},
                'LaboratoryVerificationEvidence': {'type': 'object', 'additionalProperties': True},
                'ProfessionalModel': {'type': 'object', 'additionalProperties': True},
                'EvolutionStatus': {'type': 'object', 'additionalProperties': True},
            },
        },
        'paths': {
            '/vectra/runtime/status': {
                'get': {
                    ...
                    'security': security,
                    'responses': {'200': {'description': 'Runtime status', 'content': {'application/json': {'schema': {'$ref': '#/components/schemas/RuntimeStatus'}}}}},
                }
            },
            '/vectra/runtime/snapshot': {
                'get': {
                    ...
                    'security': security,
                    'parameters': [{'name': 'refresh', 'in': 'query', 'required': False, 'schema': {'type': 'boolean'}, 'description': 'If true, request refresh when supported.'}],
                    'responses': {'200': {'description': 'Runtime Snapshot', 'content': {'application/json': {'schema': {'$ref': '#/components/schemas/RuntimeSnapshot'}}}}},
                }
            },
            '/vectra/laboratory/verification': {
                'get': {
                    ...
                    'security': security,
                    'parameters': [{'name': 'runtime_url', 'in': 'query', 'required': False, 'schema': {'type': 'string'}, 'description': 'Optional Runtime URL to echo into evidence package.'}],
                    'responses': {'200': {'description': 'Laboratory Verification Evidence', 'content': {'application/json': {'schema': {'$ref': '#/components/schemas/LaboratoryVerificationEvidence'}}}}},
                }
            },
            '/vectra/professional/model': {
                'get': {
                    ...
                    'security': security,
                    'responses': {'200': {'description': 'Professional Model', 'content': {'application/json': {'schema': {'$ref': '#/components/schemas/ProfessionalModel'}}}}},
                }
            },
            '/vectra/evolution/status': {
                'get': {
                    ...
                    'security': security,
                    'responses': {'200': {'description': 'Evolution status', 'content': {'application/json': {'schema': {'$ref': '#/components/schemas/EvolutionStatus'}}}}},
                }
            },
        },
...
@router.get('/vectra/laboratory/openapi.json', summary='Read VECTRA Laboratory Public OpenAPI schema')
def vectra_laboratory_openapi_schema():
    return JSONResponse(content=_laboratory_public_openapi_schema())


@router.get('/laboratory/openapi.json', summary='Alias: Read VECTRA Laboratory Public OpenAPI schema')

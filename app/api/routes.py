...
def _laboratory_public_openapi_schema() -> dict:
    ...
    return {
        ...
        'info': {
            ...
            'version': os.getenv('VECTRA_LABORATORY_SCHEMA_VERSION', 'FOUNDATION-0008-BUSINESS-DATA-LABORATORY-ACCESS'),
        ...
        'paths': {
            ...
            '/vectra/laboratory/business-data/status': {
                'get': {
                    ...
                    'description': 'Confirms that Laboratory has read-only access to the same Business Data source used by Working GPT.',
                    'security': security,
            ...
            '/vectra/laboratory/business-data/query': {
                'get': {
                    ...
                    'description': 'Runs the same existing query/orchestration path used by Working GPT without exposing Business Data mutation endpoints.',
                    'security': security,
            ...
            '/vectra/laboratory/business-data/verify': {
                'get': {
                    ...
                    'summary': 'Verify Laboratory read-only Business Data access',
                    'description': 'Verifies source loading, entity access, sample rows and read-only boundary.',
                    'security': security,

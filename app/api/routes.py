...
def _build_product_team_autonomous_research_workspace(obj: str, session_id: str, *, trigger: str = 'continue') -> dict:
    ...
    research_state = {
        'version': 'DEV_0004_RESEARCH_RUNTIME_BRIDGE',
        'trigger': trigger,
        'status': 'completed_with_available_information',
        'object_name': obj,
        'current_step': 'product_owner_report',
        'next_step': 'laboratory_review',
        'research_path': [
        ...
        'runtime_rule': 'Continue Product Team research route before ordinary free dialogue while this state is active.',
    }
    state = {

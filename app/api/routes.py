...
def _laboratory_facade_openapi_schema() -> dict:
    ...
    schema = {
        ...
        'info': {
            ...
            'description': 'Official compact OpenAPI schema for VECTRA Laboratory GPT Actions. Product Owner imports this single URL. LABORATORY-KNOWLEDGE-0009 defines compact capitalization responses plus Knowledge Package Builder, normalization, deduplication and automatic batch capitalization. VECTRA performs audit and intellectual extraction; Runtime builds the safe write package, performs incremental diff, batch persistence, readback verification and the final report.',
        },
        'servers': [{'url': server_url}],
        'components': {
            'schemas': {},

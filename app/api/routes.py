...
def _laboratory_public_openapi_schema() -> dict:
    ...
    FOUNDATION-0003 BUG-001 rebuild 2:
    - no response $ref references are used;
    - no components.schemas are published;
    ...
    return {
        ...
        'info': {
            ...
            'version': os.getenv('VECTRA_LABORATORY_SCHEMA_VERSION', 'FOUNDATION-0003-BUG-001-OPENAI-ACTIONS-REBUILT'),
        ...
        'x-vectra-openai-actions-compatibility': 'FOUNDATION-0003-BUG-001 rebuild 2: no response refs; no components.schemas; every object schema has explicit properties.',

...
def public_summary(payload):
    if not isinstance(payload, dict):
        return payload
    optional_keys = ('all_block', 'cause_block', 'focus_block', 'decision_block', 'provocation_block')
    compact = {key: payload.get(key) for key in PUBLIC_SUMMARY_KEYS if key in payload}

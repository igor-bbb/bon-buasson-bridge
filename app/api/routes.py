...
def _laboratory_public_openapi_schema() -> dict:
    ...
    return {
        ...
        'info': {
            ...
            'version': os.getenv('VECTRA_LABORATORY_SCHEMA_VERSION', 'FOUNDATION-0008-PV-BUSINESS-DATA-ACTIONS'),
            'description': 'Public Action-facing API for VECTRA Laboratory. Includes read-only Business Data endpoints required for FOUNDATION-0008-PV Product Verification without Product Owner mediation.',
        },

...
def _facade_operation_request_schema() -> dict:
    prepared_package_schema = {
        'type': 'object',
        'description': (
            'Prepared Knowledge Package produced by VECTRA after intellectual dialogue analysis. '
            'When operation_type=capitalize_confirmed_knowledge and this object is supplied, Runtime MUST set '
            'knowledge_input_mode=prepared_knowledge_package and runtime_reanalysis_performed=false.'
        ),
        'properties': {
...
def _laboratory_facade_openapi_schema() -> dict:
    ...
    schema = {
        ...
        'info': {
            ...
            'version': 'LABORATORY-KNOWLEDGE-0006-INTEGRATION-FIX-PREPARED-PACKAGE',
        ...
        'x-vectra-release': 'LABORATORY-KNOWLEDGE-0006-INTEGRATION-FIX',
...
def _normalize_facade_request(request: dict | None) -> tuple[str, dict, bool, str, str, str]:
    ...
    # LABORATORY-KNOWLEDGE-0006-INTEGRATION-FIX:

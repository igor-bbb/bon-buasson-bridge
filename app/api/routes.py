...
def _laboratory_public_openapi_schema() -> dict:
    ...
    return {
        ...
        'info': {
            ...
            'version': os.getenv('VECTRA_LABORATORY_SCHEMA_VERSION', 'FOUNDATION-0009-SELF-INSPECTION-KNOWLEDGE-CAPITALIZATION'),
            'description': 'Public Action-facing API for VECTRA Laboratory. Includes read-only Business Data, Repository Inspection and Product Owner approved Knowledge Capitalization endpoints required for FOUNDATION-0009 Product Verification.',
        },
        ...
        'paths': {
            ...
            '/vectra/knowledge/capitalization': {
                'post': {
                    ...
                    'summary': 'Capitalize Product Owner approved knowledge',
                    'description': 'Runs Write -> Readback -> Recovery Snapshot -> Evolution Journal capitalization flow. Requires product_owner_approval=true.',
                    'security': security,
                    'requestBody': {'required': True, 'content': {'application/json': {'schema': capitalization_request_schema}}},

...
def _laboratory_public_openapi_schema() -> dict:
    ...
    return {
        ...
        'info': {
            ...
            'version': os.getenv('VECTRA_LABORATORY_SCHEMA_VERSION', 'FOUNDATION-0003-BUG-001-FINAL-OPENAI-COMPATIBILITY'),
        ...
        'x-vectra-openai-actions-compatibility': 'FOUNDATION-0003-BUG-001 final: no response refs; components.schemas is {}; every object schema has explicit properties.',

...
def vectra_query(request: VectraQueryRequest):
    ...
    logger.info(
        ...
        session_id,
        'kpi_block' in rendered_payload,
        'structure_block' in rendered_payload,
        'drain_block_render' in rendered_payload,
        'navigation_block' in rendered_payload,
        'goal_block' in rendered_payload,
    )
    _log_vectra_query_payload(session_id, rendered_payload)
    return json_response(rendered_payload)

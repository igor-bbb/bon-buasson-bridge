...
def public_summary(payload):
    ...
    response = {
        ...
        'focus_money': payload.get('focus_money'),
        'path_goal_money': payload.get('path_goal_money'),
...
def _attach_render_blocks(response, payload):
    ...
    if ctx_level == 'business':
        vector_block = {}
        response.pop('focus_money', None)
        response.pop('path_goal_money', None)
        response['vector_block'] = {}
    ...
    if render_mode == 'list_only':
        ...
        response['goal_block'] = '' if ctx_level == 'business' else _render_goal_block(goal, vector_block)
...
def vectra_query(request: VectraQueryRequest):
    ...
    render_only_payload = {
        ...
        'focus_money': rendered_payload.get('focus_money'),
        'path_goal_money': rendered_payload.get('path_goal_money'),
    }

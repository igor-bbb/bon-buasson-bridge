...
def _is_product_owner_autonomous_research_start(message: str) -> bool:
    ...
    owner_research_phrases = (
        ...
        'починай дослідження', 'запусти дослідження',
        'start autonomous research', 'run autonomous research',
        'start product research', 'run product research',
    )
    return any(phrase in text for phrase in owner_research_phrases) or any(phrase in raw_text for phrase in owner_research_phrases)
...
def vectra_query(request: VectraQueryRequest):
    ...
    if _is_product_owner_autonomous_research_start(request.message):

...
def _laboratory_facade_openapi_schema() -> dict:
    ...
    schema = {
        ...
        'info': {
            ...
            'version': 'LABORATORY-KNOWLEDGE-0007-PREPARED-KNOWLEDGE-PACKAGE',
            'description': 'Official compact OpenAPI schema for VECTRA Laboratory GPT Actions. Product Owner imports this single URL. LABORATORY-KNOWLEDGE-0007 defines the final prepared_knowledge_package contract with professional_knowledge, business_knowledge and product_knowledge arrays. VECTRA performs intellectual analysis; Runtime performs validation, incremental diff, persistence and verification.',
        },
        'servers': [{'url': server_url}],
        'components': {
            'schemas': {},
        ...
        'x-vectra-release': 'LABORATORY-KNOWLEDGE-0007',

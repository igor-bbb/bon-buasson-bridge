...
def _laboratory_facade_openapi_schema() -> dict:
    ...
    schema = {
        ...
        'info': {
            ...
            'description': 'Official compact OpenAPI schema for VECTRA Laboratory GPT Actions. Product Owner imports this single URL. LABORATORY-KNOWLEDGE-0008 defines compact capitalization responses and the final prepared_knowledge_package contract with professional_knowledge, business_knowledge and product_knowledge arrays. VECTRA performs intellectual analysis; Runtime performs validation, incremental diff, persistence and verification.',
        },
        'servers': [{'url': server_url}],
        'components': {
            'schemas': {},
...
def _compact_capitalization_facade_result(result: Any, operation_type: str = 'capitalize_confirmed_knowledge') -> dict:
    ...
    LABORATORY-KNOWLEDGE-0008 prevents ResponseTooLargeError by keeping full

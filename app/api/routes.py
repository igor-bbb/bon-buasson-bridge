...
def _laboratory_facade_openapi_schema() -> dict:
    ...
    schema = {
        ...
        'info': {
            ...
            'version': 'LABORATORY-KNOWLEDGE-0004-AUTO-CAPITALIZATION-FACADE',
        ...
        'x-vectra-release': 'LABORATORY-KNOWLEDGE-0004',
...
def _internal_runtime_actions() -> list[dict]:
    ...
    for action in actions:
        ...
        action['release_version'] = 'LABORATORY-KNOWLEDGE-0004'
    return actions
...
def _build_laboratory_facade_action_manifest() -> dict:
    ...
    return {
        ...
        'render_mode': 'vectra_laboratory_action_manifest',
        'release_version': 'LABORATORY-KNOWLEDGE-0004',
        'schema_url': '/vectra/laboratory/openapi.json',

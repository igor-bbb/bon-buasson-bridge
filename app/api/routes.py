...
@router.post('/vectra/runtime/product-verification', summary='Run VECTRA Runtime Product Verification')
def vectra_runtime_product_verification():
    return json_response(run_vectra_runtime_product_verification())

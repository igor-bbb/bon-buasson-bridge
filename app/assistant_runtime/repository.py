...
REPOSITORY_VERSION = "VECTRA-RUNTIME-0001"
...
def _seed_state() -> Dict[str, Any]:
    return {
        ...
        'assistant_identity': {
            ...
            'home_system': 'VECTRA',
            'role': 'internal professional service of VECTRA',
            'mission': 'support product development, product acceptance, knowledge evolution and VECTRA continuous improvement',
        },
...
def _seed_manifest() -> Dict[str, Any]:
    return {
        ...
        'purpose': 'Persistent professional memory and operating environment for Product Team Assistant inside VECTRA.',
...
def get_current_state() -> Dict[str, Any]:
    ...
    if not isinstance(state, dict):
        state = _seed_state()
    return {'status': 'ok', 'render_mode': 'assistant_runtime_state', 'state': state}

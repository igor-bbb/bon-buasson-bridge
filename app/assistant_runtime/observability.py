...
RUNTIME_VERIFICATION_AUTOMATION_RELEASE = "GENESIS-0013"
...
def run_runtime_verification_evidence(runtime_url: Optional[str] = None, reason: str = "laboratory_automated_runtime_verification") -> Dict[str, Any]:
    ...
    acceptance_scenario = [
        ...
        {"step": 5, "name": "Runtime release matches automated verification release", "status": "PASS" if snapshot.get("release_version") == "GENESIS-0013" else "FAIL"},

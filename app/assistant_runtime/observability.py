...
from app.assistant_runtime.review import get_review_status, get_review_session, get_review_report, verify_review_readback, get_synchronization_execution_status, get_synchronization_execution_report, verify_synchronization_execution_readback
...
def _build_components() -> Dict[str, Dict[str, Any]]:
    ...
    workspace_objects = ["professional_model", "professional_state", "evolution_journal", "recovery_bundle", "knowledge_candidates", "reflection_reports", "professional_observations", "observation_reports", "active_responsibilities", "responsibility_reports", "recovery_evolution_status", "recovery_evolution_reports", "recovery_checkpoints", "synchronization_status", "synchronization_reports", "synchronization_packages", "review_status", "review_sessions", "review_reports", "synchronization_execution_status", "synchronization_execution_reports", "synchronization_execution_history", "working_vectra_state"]

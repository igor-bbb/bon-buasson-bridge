...
def _handle_entry_flow(message: str, session_id: str, session_ctx: Dict[str, Any]) -> Optional[Dict[str, Any]]:
    ...
    if entry_step == 'await_period':
        ...
        update_session(session_id, {
            'entry_step': None,
            'entry_level': None,
            'scope_level': level if level == 'business' else session_ctx.get('scope_level'),
            'scope_object_name': object_name if level == 'business' else session_ctx.get('scope_object_name'),

...
def enforce_contract(response: Dict[str, Any]) -> Dict[str, Any]:
    ...
    required = {'context', 'metrics', 'goal', 'navigation'}
    sku_required = {'context', 'metrics', 'goal', 'status', 'navigation'}
    standard_required = {'context', 'metrics', 'structure', 'drain_block', 'goal', 'navigation'}
    network_required = {'context', 'metrics', 'structure', 'drain_block', 'goal', 'focus_block', 'decision_block', 'navigation'}
    if sku_required.issubset(set(data.keys())) or network_required.issubset(set(data.keys())) or standard_required.issubset(set(data.keys())):
        return response

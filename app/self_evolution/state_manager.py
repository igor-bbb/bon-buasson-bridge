"""Assistant State Manager for SEE DEV-0010.
...
STATE_MODEL_VERSION = "SEE-0010.1"
...
def default_responsibility_state() -> Dict[str, Any]:
    ...
    return {
        ...
        "active_evolution_cycles": [
            {
                ...
                "status": "in_progress",
                "current_step": "autonomous_work_cycle_management",
                "required_completion_steps": [
                    "confirmed_knowledge_detection",
                    "priority_assessment",
                    "autonomous_work_queue",
                    "single_cycle_completion",
                    "next_work_selection",
                    "product_acceptance_required",
                ],
                "next_required_action": "Product Acceptance DEV-0010",
            }
        ],
        "pending_product_acceptance": [
            {
                ...
                "acceptance_focus": [
                    "Confirmed knowledge starts autonomous SEE",
                    "Assistant prioritizes active obligations",
                    "Assistant completes one full cycle before next work",
                    "Autonomous work queue is visible",
                ],
            }
        ],
        "research_queue": [
            {
                "id": "SEE-RESEARCH-001",
                "title": "Autonomous Product Team Assistant work management",
                "status": "in_progress",
        ...
        "knowledge_integration_queue": [
            {
                "id": "KNOW-0010-001",
                "title": "Autonomous work queue management as part of Self Evolution",
                "knowledge_type": "architecture_principle",
                "status": "integration_pending_product_acceptance",
                "related_release": "DEV-0010",
            }
        ],
        "engineering_review_queue": [
            {
                "id": "ENG-0010-001",
                "title": "Verify Autonomous Self Evolution endpoints and release cleanup",
        ...
        "state_recovery_contract": {
            ...
            "recovery_question": "What must Product Team Assistant complete next, and in what priority?",
            "completion_rule": "Assistant State recovery is complete only when active obligations, unfinished work cycles and autonomous work queue are visible.",
        },
        "created_at": now_iso(),
        "updated_at": now_iso(),
    }

"""Assistant State Manager for SEE DEV-0011B.
...
STATE_MODEL_VERSION = "PAE-0011B.1"
...
def default_responsibility_state() -> Dict[str, Any]:
    ...
    return {
        ...
        "state_manager_principle": "Product Team Assistant must recover identity, responsibilities, unfinished work cycles and a value-ranked professional work queue.",
        "responsibilities": [
            {
                "id": "RESP-001",
        ...
        "active_evolution_cycles": [
            {
                "id": "SEE-CYCLE-0010",
                "title": "Professional Activity Engine — Value & Priority",
                "status": "in_progress",
                "current_step": "value_priority_planning",
                ...
                "next_required_action": "Product Acceptance DEV-0011B",
            }
        ],
        "pending_product_acceptance": [
            {
                "release_id": "DEV-0011B",
                "title": "Professional Activity Engine — Value & Priority",
                "status": "pending_after_deploy",
                "acceptance_focus": [
                    "Assistant evaluates professional work blocks by expected product value",
                    "Assistant chooses next professional work block by value and priority",
                    "Assistant considers dependencies between Product Acceptance, research and knowledge integration",
                    "Value and priority evaluation is visible in recovery state",
                ],
            }
        ],
        "research_queue": [
            {
                ...
                "target_stage": "DEV-0011B",
            }
        ],
        "knowledge_integration_queue": [
            {
                "id": "KNOW-0010-001",
                "title": "Value & Priority Engine as next layer of Professional Activity Engine",
                "knowledge_type": "architecture_principle",
                "status": "integration_pending_product_acceptance",
                "related_release": "DEV-0011B",
            }
        ],
        "engineering_review_queue": [
            {
                "id": "ENG-0010-001",
                "title": "Verify Value & Priority Engine endpoints and release cleanup",
        ...
        "state_recovery_contract": {
            ...
            "recovery_question": "What professional work block must Product Team Assistant complete next, and why is it the highest-value block now?",
            "completion_rule": "Assistant State recovery is complete only when active obligations, unfinished work cycles, autonomous work queue, professional activity plan and value-priority evaluation are visible.",
        },
        "created_at": now_iso(),
        "updated_at": now_iso(),
    }

...
IDENTITY_MODEL_VERSION = "SEE-0009C.1"
...
def default_assistant_state() -> Dict[str, Any]:
    return {
        ...
        "current_development_model": {
            "completed": ["DEV-0009A Repository Foundation", "DEV-0009B Evolution Policy"],
            "current": "DEV-0009C Identity & Recovery",
            "next": "DEV-0009D Assistant State Manager",
        },
        "recovery_contract": {
            "must_restore": [
                "professional_identity",
...
def recover_assistant_identity_state(*, recent_decisions: List[Dict[str, Any]] | None = None, graph_summary: Dict[str, Any] | None = None) -> Dict[str, Any]:
    ...
    restored = {
        "status": "ok",
        "recovery_mode": "identity_and_recovery",
        ...
        "recovery_completed_as": "Product Team Assistant professional state restored",
    }
    return restored

...
DEV-0009C makes Product Team Assistant the center of SEE. Recovery restores
professional identity, methodology, active research and development state, while
Assistant Evolution Memory remains infrastructure.
"""
...
def run_self_evolution_cycle(
    *,
    ...
    return {
        ...
        "instruction_update_note": "Требуется обновление инструкции VECTRA: добавить Identity & Recovery, восстановление профессионального состояния Assistant и новые публичные поля SEE.",
    }

...
def _build_decision_workspace(
    ...
    return {
        "type": "network_decision_workspace",
        "stage": "8.2",
        "rendering_priority": "decision_workspace",
        "legacy_object_screen_allowed": False,
        "contract": clean_text(object_name),
        "period": period,
        "main_question": "Что необходимо сделать с данным контрактом, чтобы увеличить прибыль?",

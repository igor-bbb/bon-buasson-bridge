...
def build_self_model(
    ...
    *,
    ...
    professional_business_model = get_professional_business_model_summary(domain_id)
    ...
    return {
        ...
        "self_understanding": {
            ...
            "knows_professional_business_model_foundation": professional_business_model.get("status") == "PASS",
